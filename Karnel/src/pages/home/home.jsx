    ...
    return (
        <>
            ...
            <div className="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
                <div
                    className="container bg-[linear-gradient(rgba(15, 23, 43, 0.7), rgba(15, 23, 43, 0.7)), url(/img/booking.jpg)] bg-center bg-cover bg-no-repeat">
                    <div className="p-5">
                        <div className="row g-5 align-items-center">
                            <div className="col-md-6 text-white">
                                ...
                                <p className="mb-4">Tempor erat elitr rebum at clita. Diam dolor diam ipsum sit. Aliqu
                                    diam amet diam
                                    et eos. Clita erat ipsum et lorem et sit, sed stet lorem sit clita duo justo magna
                                    dolore erat
                                    amet</p>
                                    ...
                                    <div className="row g-3">
                                        <div className="col-md-6">
                                            <div className="form-floating">
                                                <input type="text" className="form-control bg-transparent" id="name"
                                        ...
                                        <div className="col-12">
                                            <div className="form-floating">
                          <textarea className="form-control bg-transparent h-[100px]" placeholder="Special Request"
                                    id="message"
                          ></textarea>
                                        ...
                                        <div className="col-12">
                                            <button className="btn btn-outline-light w-100 py-3" type="submit">Book
                                                Now
                                            </button>
                                        </div>
                                    </div>
