            ...
            {tour ? (
                <div>
                    ...
                    <div className="flex gap-8">
                                        ...
                                        <AccordionItem key={index} value={`day-${day.day}`}
                                            ...
                                            <div className="grow pt-1 pb-8 pl-4">
                                                <AccordionTrigger className="text-lg pt-0">
                                                    <div>
                                                        <span
                                                            className="text-muted-foreground pr-1">Day {day.day}: </span>
                                                        {day.title}
                                                    </div>
                                                </AccordionTrigger>
                                                <AccordionContent
                        ...
                        {/*  Sticky Sidebar  */}
                        <div className="sticky top-6 bottom-2 w-1/3 h-fit rounded-lg bg-white p-8 mb-10">
                            <h3 className="text-3xl py-4">${tour.price} <span
                                className="text-muted-foreground text-sm font-light ">/night</span></h3>
                            <div className="grid grid-cols-2 border-2 border-muted rounded-lg">
                                <div className="col-span-1 flex items-center gap-3 p-4">
                                    <Calendar/>
                                    <div>
                                        <h4>Check In</h4>
                                        <span>{moment(tour.startDate).format('MMMM Do, YYYY')}</span>
                                    </div>
                                </div>
                                <div className="col-span-1 flex items-center gap-3 p-4">
                                    <Calendar/>
                                    <div>
                                        <h4>Check Out</h4>
                                        <span>{moment(tour.endDate).format('MMMM Do, YYYY')}</span>
                                    </div>
                                </div>
